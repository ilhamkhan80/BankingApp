...
const Icon: React.FC<Props> =
    ({
        type = 'Ionicons', color = '#cacfcf', size = 20, name = 'search', light, small, CustomStyle }) => {
        switch (type) {
            case 'Ionicons':
            ...
            case 'FontAwesome5':
                return <FontAwesome5 name={name} style={{ color: light ? '#cacfcf' : color, fontSize: small ? 16 : size, ...CustomStyle }} />
            case 'Feather':
