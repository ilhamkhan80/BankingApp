...
const HomeScreen = () => {
    ...
    return (
        <View style={Styles.MainView}>
                ...
                <ImageBackground resizeMode='contain' style={Styles.ImageBackground} source={require('../../images/rectangle2.png')}>
                    <View style={Styles.ImageTextView}>
                        ...
                        <Image style={Styles.BellStyle} source={require('../../images/whitebell.png')} />
                ...
                <View style={Styles.RectangleView}>
                    ...
                    <View style={Styles.RectangleImageView}>
                        <ImageBackground style={{ width: '100%', height: 115 }} source={require('../../images/Rectangle3.png')} >
                    ...
                    <View style={[Styles.SpecialPromoView, { marginTop: '5%' }]}>
                    ...
                    <View style={[Styles.ListStyle, { top: -7 }]}>
                    ...
                    <View style={Styles.ListStyle}>
                        ...
                        <View>
                            <Text style={[Styles.DollarsStyle, { left: 70, }]}>+$ 81.12,00</Text>
                        </View>
                    </View>
